...
def test_literature_suggesters_book_title(api_client, create_record):
...
def test_literature_suggesters_abstract_source(api_client, create_record):
...
def test_literature_suggesters_empty_result(api_client, create_record):
...
def test_author_suggesters(api_client, create_record):
    data = {
        "name": {
