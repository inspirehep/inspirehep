...
@Component({
  ...
  styleUrls: ['./manual-merge-modal.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ManualMergeModalComponent extends SubscriberComponent
  implements OnInit {
  ...
  openUpdateRecordInNewTab() {
    this.domUtilsService.openHostRelativeUrlInNewTab(
      `${this.currentRecordType}/${this.updateRecordId}`
    );
  }
