...
const GUTTER = [{ xs: 0, md: 32, xl: 64 }, { xs: 16, lg: 0 }];
    ...
    <Row justify="center" gutter={GUTTER}>
      ...
      <Col xs={24} md={12} lg={6}>
        <SubmissionCard title="Author" formLink={SUBMISSIONS_AUTHOR}>
          ...
          <p>All submissions will be visible upon apporval.</p>
        </SubmissionCard>
      </Col>
      <Col xs={24} md={12} lg={6}>
      ...
      <Col xs={24} md={12} lg={6}>
        <SubmissionCard title="Conferece" formLink={SUBMISSIONS_CONFERENCE}>
