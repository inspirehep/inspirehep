...
type LiteratureSubmissionPageProps = {
    onSubmit: $TSFixMeFunction;
    error?: $TSFixMe; // TODO: PropTypes.instanceOf(Map)
    importedFormData?: $TSFixMe; // TODO: PropTypes.instanceOf(Map)
};

function LiteratureSubmissionPage({ error, importedFormData, onSubmit }: LiteratureSubmissionPageProps) {
