    ...
    return (<Form>
        ...
        <CollapsableForm openSections={OPEN_SECTIONS}>
          ...
          <(CollapsableForm as $TSFixMe).Section header="Publication Info" key="publication_info">
            <Field name="series_title" label="Series Title" component={TextField}/>
            <Field name="volume" label="Volume" component={TextField}/>
            <Field name="publication_date" label="Publication Date" placeholder="YYYY-MM-DD, YYYY-MM or YYYY" component={TextField}/>
            <Field name="publisher" label="Publisher" component={TextField}/>
            <Field name="publication_place" label="Publication Place" component={TextField}/>
          </(CollapsableForm as $TSFixMe).Section>
          // @ts-expect-error ts-migrate(2552) FIXME: Cannot find name 'header'. Did you mean 'Headers'?
