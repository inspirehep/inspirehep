...
describe('links section', () => {
  ...
  it('validates when pdf_link is a link', async (done: $TSFixMe) => {
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('invalidates when pdf_link is not a link', async (done: $TSFixMe) => {
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('validates when additonal_link is a link', async (done: $TSFixMe) => {
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
    expect(
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('invalidates when additonal_link is not a link', async (done: $TSFixMe) => {
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('validates with special characters', async (done: $TSFixMe) => {
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
    expect(
      await schema.isValid({
        pdf_link:
