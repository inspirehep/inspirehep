...
describe('thesisInfo section', () => {
  ...
  it('validates when submission_date is a date', async (done: $TSFixMe) => {
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('invalidates when submission_date is not a date', async (done: $TSFixMe) => {
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('validates when supervisors only contains empty item', async (done: $TSFixMe) => {
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
