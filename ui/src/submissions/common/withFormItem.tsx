 ...
 */
export default function withFormItem(FormInputComponent: $TSFixMe) {
  ...
  (WithFormItem as $TSFixMe).defaultProps = {
    labelCol: LABEL_COL,
    wrapperCol: WRAPPER_COL,
};

  (WithFormItem as $TSFixMe).displayName = getWrapperComponentDisplayName('WithFormItem', FormInputComponent);
  return WithFormItem;
}
