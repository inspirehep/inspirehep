...
type DetailPageProps = {
    ...
    publicationsQuery: $TSFixMe; // TODO: PropTypes.instanceOf(Map)
...
// @ts-expect-error ts-migrate(2339) FIXME: Property 'loadingPublications' does not exist on t... Remove this comment to see the full error message
function DetailPage({ record, publicationsQuery, userOrcid, dispatch, publicationsCount, citingPapersCount, loadingPublications, seminarsCount, isCatalogerLoggedIn, }: DetailPageProps) {
...
export default withRouteActionsDispatcher(DetailPageContainer, {
  ...
  loadingStateSelector: (state: $TSFixMe) => !state.authors.hasIn(['data', 'metadata']),
});
