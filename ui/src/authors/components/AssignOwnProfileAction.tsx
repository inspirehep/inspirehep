...
type Props = OwnProps & typeof AssignOwnProfileAction.defaultProps;

function AssignOwnProfileAction({ onAssign, disabled, disabledAssignAction, numberOfSelected, claimingTooltip, }: Props) {
