...
type OwnProps = {
    onAssignToAnotherAuthor: $TSFixMeFunction;
...
type Props = OwnProps & typeof AssignAction.defaultProps;

function AssignAction({ onAssignToAnotherAuthor, onAssign, disabled, numberOfSelected, }: Props) {
