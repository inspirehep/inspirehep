...
export function assigning(key: string) {
  notification.info({
    key,
    message: 'Assigning...',
...
export function curating(key: string) {
  notification.info({
    key,
...
export function curationError(key: string) {
...
export function assignLiteratureItemError(key: string) {
  notification.close(key);
  notification.error({
    className: 'super-zindex',
...
export function assignError(key: string) {
  notification.close(key);
  notification.error({
    className: 'super-zindex',
    message: 'Assignment Error!',
...
export function exportToCdsSuccess({ papers }: { papers: Map<string, any> }) {
  notification.success({
