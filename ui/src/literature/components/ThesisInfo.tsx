...
type OwnProps = {
    thesisInfo?: $TSFixMe; // TODO: PropTypes.instanceOf(Map)
};

type Props = OwnProps & typeof ThesisInfo.defaultProps;

class ThesisInfo extends Component<Props> {
  ...
  renderInstutions() {
    ...
    return (
      <InlineList
        ...
        extractKey={(institution: $TSFixMe) => institution.get('name')}
        renderItem={(institution: $TSFixMe) => <Institution institution={institution} />}
      />
    );
  }
