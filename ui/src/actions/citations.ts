...
function fetchingCitationSummary(namespace: $TSFixMe) {
  return {
...
function fetchCitationSummarySuccess(result: $TSFixMe) {
  return {
...
function fetchCitationSummaryError(error: $TSFixMe) {
  return {
...
export function fetchCitationSummary(namespace: $TSFixMe) {
...
function fetchCitationsByYearSuccess(result: $TSFixMe) {
  return {
...
function fetchCitationsByYearError(error: $TSFixMe) {
  return {
...
export function fetchCitationsByYear(literatureSearchQuery: $TSFixMe) {
  return async (dispatch: $TSFixMe, getState: $TSFixMe, http: $TSFixMe) => {
