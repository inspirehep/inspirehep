...
export const BACKOFFICE_DASHBOARD_REQUEST = 'BACKOFFICE_DASHBOARD_REQUEST';
export const BACKOFFICE_DASHBOARD_SUCCESS = 'BACKOFFICE_DASHBOARD_SUCCESS';
export const BACKOFFICE_DASHBOARD_ERROR = 'BACKOFFICE_DASHBOARD_ERROR';
