...
function submitBibliographyGeneratorSuccess(payload: $TSFixMe) {
  return {
...
function submitBibliographyGeneratorError(error: $TSFixMe) {
  return {
...
export function submitBibliographyGenerator(format: $TSFixMe, data: $TSFixMe) {
