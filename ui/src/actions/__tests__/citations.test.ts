...
describe('citations - async action creator', () => {
  ...
  it('creates CITATIONS_SUMMARY_SUCCESS if successful', async (done: $TSFixMe) => {
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('creates CITATIONS_SUMMARY_ERROR if unsuccessful', async (done: $TSFixMe) => {
    const query = { q: 'stuff' };
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('creates CITATIONS_BY_YEAR_SUCCESS if successful', async (done: $TSFixMe) => {
    mockHttp
      .onGet(
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('creates CITATIONS_BY_YEAR_ERROR if unsuccessful', async (done: $TSFixMe) => {
    mockHttp
