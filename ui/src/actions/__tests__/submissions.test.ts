...
describe('submissions - async action creator', () => {
  ...
  describe('submit', () => {
    ...
    it('creates SUBMIT_SUCCESS and pushes /submissions/success to history if successful', async (done: $TSFixMe) => {
    ...
    // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
    it('creates SUBMIT_ERROR if not successful', async (done: $TSFixMe) => {
  ...
  describe('submitUpdate', () => {
    // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
    it('creates SUBMIT_SUCCESS and pushes /submissions/:type/:id/success to history if successful', async (done: $TSFixMe) => {
  ...
  describe('fetchUpdateFormData', () => {
    // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
    it('creates INITIAL_FORM_DATA_SUCCESS', async (done: $TSFixMe) => {
      const submissionUrl = '/submissions/authors/123';
      const data = { field: 'value' };
    ...
    // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
    it('creates INITIAL_FORM_DATA_ERROR if not successful', async (done: $TSFixMe) => {
      const submissionUrl = '/submissions/jobs/123';
