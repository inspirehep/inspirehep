...
describe('bibliographyGenerator - async action creators', () => {
  ...
  it('creates BIBLIOGRAPHY_GENERATOR_SUCCESS if successful', async (done: $TSFixMe) => {
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('creates BIBLIOGRAPHY_GENERATOR_ERROR if not successful', async (done: $TSFixMe) => {
    mockHttp
