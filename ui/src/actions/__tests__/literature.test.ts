...
describe('literature - async action creators', () => {
  ...
  it('happy - creates LITERATURE_SUCCESS', async (done: $TSFixMe) => {
  ...
  // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
  it('unhappy - creates LITERATURE_ERROR', async (done: $TSFixMe) => {
  ...
  describe('literature references', () => {
    // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
    it('happy - creates LITERATURE_REFERENCES_SUCCESS', async (done: $TSFixMe) => {
      mockHttp
    ...
    // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
    it('fetches references with merging the given query into the existing one ', async (done: $TSFixMe) => {
      mockHttp
    ...
    // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
    it('unhappy - creates LITERATURE_REFERENCES_ERROR', async (done: $TSFixMe) => {
      mockHttp
        .onGet('/literature/123/references?size=10&page=1')
  ...
  describe('literature authors', () => {
    // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
    it('happy - creates LITERATURE_AUTHORS_SUCCESS', async (done: $TSFixMe) => {
    ...
    // @ts-expect-error ts-migrate(2582) FIXME: Cannot find name 'it'. Do you need to install type... Remove this comment to see the full error message
    it('unhappy - creates LITERATURE_AUTHORS_ERROR', async (done: $TSFixMe) => {
