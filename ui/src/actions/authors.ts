...
export function setPublicationSelection(publicationIds: $TSFixMe, selected: $TSFixMe) {
  return {
...
export function setPublicationsClaimedSelection(papersIds: $TSFixMe, selected: $TSFixMe) {
  return {
...
export function setPublicationsUnclaimedSelection(papersIds: $TSFixMe, selected: $TSFixMe) {
  return {
...
export function setPublicationsCanNotClaimSelection(papersIds: $TSFixMe, selected: $TSFixMe) {
  return {
