...
export function onLiteratureQueryChange(helper: $TSFixMe) {
...
export function onEmbeddedLiteratureQueryChange(helper: $TSFixMe) {
...
export function onEmbeddedSearchWithAggregationsQueryChange(helper: $TSFixMe) {
  if (helper.hasQueryChanged()) {
    helper.fetchSearchResults();
  }
...
export function onAggregationlessCollectionQueryChange(helper: $TSFixMe) {
...
export function onJobsQueryChange(helper: $TSFixMe) {
  if (helper.isInitialQueryUpdate() || helper.hasQueryChanged()) {
    helper.fetchSearchResults();
    helper.updateLocation();
  }
...
export function onCollectionQueryChange(helper: $TSFixMe) {
  if (helper.isInitialQueryUpdate() || helper.hasQueryChanged()) {
    helper.fetchSearchResults();
    helper.updateLocation();
  }
...
export function onEmbeddedSearchWithoutAggregationsQueryChange(helper: $TSFixMe) {
  if (helper.hasQueryChanged()) {
    helper.fetchSearchResults();
  }
}
