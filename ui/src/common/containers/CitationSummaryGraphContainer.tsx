...
function barToQuery(bar: $TSFixMe, excludeSelfCitations: $TSFixMe) {
  if (bar == null) {
    return CLEAR_QUERY;
  }
...
function getSelectedBar(state: $TSFixMe, namespace: $TSFixMe) {
...
const dispatchToProps = (
  ...
  onSelectBarChange(bar: $TSFixMe, excludeSelfCitations: $TSFixMe) {
