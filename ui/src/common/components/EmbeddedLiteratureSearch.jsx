...
class EmbeddedLiteratureSearch extends Component {
  static renderResultItem(result, rank) {
    return (
          ...
          <Col xs={24} lg={17}>
            <LoadingOrChildren loading={loadingResults}>
              ...
              <Row>
                <Col span={24}>
                  <SearchResults
                    renderItem={EmbeddedLiteratureSearch.renderResultItem}
                    page={query.page}
                    pageSize={query.size}
                    results={results}
                  />
...
EmbeddedLiteratureSearch.defaultProps = {
  onQueryChange: null,
};
