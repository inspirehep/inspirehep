...
describe('DateRangeFilter', () => {
  ...
  it('calls onChange when start date selected and there is range', async () => {
    const onChange = jest.fn();
  ...
  it('calls onChange when end date selected and there is range', async () => {
    const onChange = jest.fn();
  ...
  it('sets start date disabled when end date before given date', async () => {
    const onChange = jest.fn();
    const screen = render(
