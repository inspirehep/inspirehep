...
describe('DateRangeFilter', () => {
  ...
  it('sets start date disabled when end date before given date', () => {
    ...
    const disabledDate = wrapper
      ...
      .prop('disabledDate');
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
    expect((disabledDate as $TSFixMe)(moment(new Date('2019-11-28T13:31:00+00:00')))).toBe(true);
  });
  ...
  it('does not set start date disabled when end date is later than given date', () => {
    ...
    const disabledDate = wrapper
      ...
      .prop('disabledDate');
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
    expect((disabledDate as $TSFixMe)(moment(new Date('2019-11-21T13:31:00+00:00')))).toBe(false);
  });
  ...
  it('sets end date disabled when start date after given date', () => {
    ...
    const disabledDate = wrapper
      ...
      .prop('disabledDate');
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
    expect((disabledDate as $TSFixMe)(moment(new Date('2019-11-21T13:31:00+00:00')))).toBe(true);
  });
  ...
  it('does not set end date disabled when start date is before than given date', () => {
    ...
    const disabledDate = wrapper
      ...
      .prop('disabledDate');
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'expect'.
    expect((disabledDate as $TSFixMe)(moment(new Date('2019-11-29T13:31:00+00:00')))).toBe(false);
  });
