  ...
  it('calls trackEvent with event args if forwardEventArgs is set', () => {
    const wrapper = shallow(
      ...
      <EventTracker
        ...
        // @ts-expect-error ts-migrate(2322) FIXME: Type '(eventArgs: $TSFixMe) => any' is not assigna... Remove this comment to see the full error message
        extractEventArgsToForward={(eventArgs: $TSFixMe) => eventArgs.filter((arg: $TSFixMe) => typeof arg === 'string')
        }
      >
