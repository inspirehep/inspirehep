...
@freeze_time("2019-06-17")
def test_new_literature_submit_no_merge_backoffice(inspire_app, requests_mock):
    requests_mock.post(
...
@freeze_time("2019-06-17")
def test_new_literature_submit_arxiv_urls_backoffice(inspire_app, requests_mock):
    requests_mock.post(
        f"{current_app.config['INSPIRE_BACKOFFICE_URL']}/api/workflows/literature/",
        json={"workflow_object_id": 30},
    )
