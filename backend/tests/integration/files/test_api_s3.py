...
def test_get_content_disposition_with_broken_filename(inspire_app, s3):
...
def test_get_content_disposition_with_subformat(inspire_app, s3):
...
def test_get_content_disposition_without_extension(inspire_app, s3):
