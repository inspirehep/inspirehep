...
def test_link_signature_to_author(app_clean):
    data = {
        "authors": [
...
def test_link_signature_to_author_with_no_change(app_clean):
    data = {
        "authors": [
            {
                "full_name": "Doe, John",
...
def test_link_signature_to_author_with_curated_signature_and_ref(app_clean):
    data = {
        "authors": [
            {
                "full_name": "Doe, John",
...
def test_link_signature_to_author_with_curated_signature_but_no_ref(app_clean):
    data = {
        "authors": [
            {
                "full_name": "Doe, John",
...
def test_link_signature_to_author_missing_uuid(app_clean):
    data = {
        "authors": [
...
def test_link_signatures_to_author(app_clean):
    data_1 = {
        "authors": [
            {"full_name": "Doe, John", "uuid": "94fc2b0a-dc17-42c2-bae3-ca0024079e51"}
        ]
...
def test_link_signatures_to_author_missing_uuid(app_clean):
    data = {
        "authors": [
...
def test_create_new_empty_author(app_clean):
