...
def test_minter_dois(app_clean):
...
def test_minter_dois_duplicate(app_clean):
    doi_value_1 = faker.doi()
    data = {
        "dois": [
...
def test_minter_dois_empty(app_clean):
...
def test_mitner_dois_already_existing(app_clean):
    doi_value = faker.doi()
...
def test_mitner_dois_missing_schema(app_clean):
    doi_value = faker.doi()
    data = {"dois": [{"value": doi_value}]}
...
def test_new_doi_converted_to_lowercase(app_clean):
...
def test_adding_same_doi_different_case_raises_pid_already_exists(app_clean):
...
def test_adding_record_with_duplicated_dois_different_case(app_clean):
    doi_value_1 = "10.1109/tpel.2019.2900393"
    doi_value_2 = "10.1109/TPEL.2019.2900393"
