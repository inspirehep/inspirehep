...
def test_minter_arxiv_eprints(app_clean):
...
def test_minter_arxiv_eprints_empty(app_clean):
...
def test_minter_arxiv_eprints_duplicate(app_clean):
    arxiv_value_1 = faker.arxiv()
    data = {
        "arxiv_eprints": [
...
def test_mitner_arxiv_eprints_already_existing(app_clean):
...
def test_mitner_arxiv_eprints_missing_schema(app_clean):
    arxiv_value = faker.arxiv()
    data = {"arxiv_eprints": [{"value": arxiv_value}]}
