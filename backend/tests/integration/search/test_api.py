...
def test_empty_literature_search(app_clean):
    create_record("lit")
    create_record("lit")
...
def test_literature_search_with_parameter(app_clean):
    record1 = create_record("lit")
    create_record("lit")
    record1_control_number = record1["control_number"]
    with app_clean.app.test_client() as client:
...
def test_empty_authors_search(app_clean):
    create_record("aut")
    create_record("aut")
    with app_clean.app.test_client() as client:
...
def test_authors_search_with_parameter(app_clean):
...
def test_empty_jobs_search(app_clean):
...
def test_jobs_search_with_parameter(app_clean):
...
def test_empty_conferences_search(app_clean):
    create_record("con")
    create_record("con")
    with app_clean.app.test_client() as client:
...
def test_conferences_search_with_parameter(app_clean):
...
def test_citations_query_result(app_clean):
...
def test_big_query_execute_without_recursion_depth_exception(app_clean):
