...
def test_inspire_query_parser_is_called(mock_inspire_query_parser, app_clean):
    query_string = "foo"
...
def test_inspire_query_parser_max_recursion_on_complicated_queries(app_clean):
