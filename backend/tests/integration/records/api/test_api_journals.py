...
def test_journals_create(base_app, db, es):
...
def test_journals_update(base_app, db, es):
    data = faker.record("jou", with_control_number=True)
    record = JournalsRecord.create(data)
...
def test_journals_create_or_update_with_new_record(base_app, db, es):
    data = faker.record("jou")
...
def test_journals_create_or_update_with_existing_record(base_app, db, es):
    data = faker.record("jou", with_control_number=True)
    record = JournalsRecord.create(data)
