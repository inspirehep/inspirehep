...
def test_journals_create(app_clean):
...
def test_journals_create_with_existing_control_number(app_clean):
...
def test_journals_create_with_invalid_data(app_clean):
    data = faker.record("jou", with_control_number=True)
...
def test_journals_update(app_clean):
    data = faker.record("jou", with_control_number=True)
    record = JournalsRecord.create(data)
...
def test_journals_create_or_update_with_new_record(app_clean):
    data = faker.record("jou")
...
def test_journals_create_or_update_with_existing_record(app_clean):
    data = faker.record("jou", with_control_number=True)
    record = JournalsRecord.create(data)
