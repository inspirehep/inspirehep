...
def test_authors_create(app_clean):
...
def test_authors_create_with_existing_control_number(app_clean):
...
def test_authors_create_with_invalid_data(app_clean):
    data = faker.record("aut", with_control_number=True)
...
def test_authors_update(app_clean):
    data = faker.record("aut", with_control_number=True)
    record = AuthorsRecord.create(data)
...
def test_authors_create_or_update_with_new_record(app_clean):
    data = faker.record("aut")
...
def test_get_author_papers(app_clean):
