...
def test_data_create(app_clean):
...
def test_data_create_with_existing_control_number(app_clean):
...
def test_data_create_with_invalid_data(app_clean):
    data = faker.record("dat", with_control_number=True)
...
def test_data_update(app_clean):
    data = faker.record("dat", with_control_number=True)
    record = DataRecord.create(data)
...
def test_data_create_or_update_with_new_record(app_clean):
    data = faker.record("dat")
...
def test_data_create_or_update_with_existing_record(app_clean):
    data = faker.record("dat", with_control_number=True)
    record = DataRecord.create(data)
...
def test_create_record_update_citation_table_for_literature_citation(app_clean):
    data = faker.record("dat")
    record = DataRecord.create(data)
...
def test_data_citation_count_property(app_clean):
    data = faker.record("dat")
    record = InspireRecord.create(data)
