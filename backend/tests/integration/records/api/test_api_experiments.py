...
def test_experiments_create(app_clean):
...
def test_experiments_create_with_existing_control_number(app_clean):
...
def test_experiments_create_with_invalid_data(app_clean):
    data = faker.record("exp", with_control_number=True)
...
def test_experiments_update(app_clean):
    data = faker.record("exp", with_control_number=True)
    record = ExperimentsRecord.create(data)
...
def test_experiments_create_or_update_with_new_record(app_clean):
    data = faker.record("exp")
...
def test_experiments_create_or_update_with_existing_record(app_clean):
    data = faker.record("exp", with_control_number=True)
    record = ExperimentsRecord.create(data)
