...
def test_literature_create(app_clean):
...
def test_literature_create_does_not_mint_if_record_is_deleted(app_clean):
...
def test_literature_create_with_mutliple_pids(app_clean):
    doi_value = faker.doi()
...
def test_literature_create_with_mutliple_updated_pids(app_clean):
    doi_value = faker.doi()
    arxiv_value = faker.arxiv()
    data = {"arxiv_eprints": [{"value": arxiv_value}], "dois": [{"value": doi_value}]}
    data = faker.record("lit", with_control_number=True, data=data)
...
def test_literature_on_delete(app_clean):
    doi_value = faker.doi()
    arxiv_value = faker.arxiv()
    data = {"arxiv_eprints": [{"value": arxiv_value}], "dois": [{"value": doi_value}]}
...
def test_literature_on_delete_through_metadata_update(app_clean):
    doi_value = faker.doi()
    arxiv_value = faker.arxiv()
    data = {"arxiv_eprints": [{"value": arxiv_value}], "dois": [{"value": doi_value}]}
    data = faker.record("lit", data=data, with_control_number=True)
...
def test_literature_create_with_existing_control_number(app_clean):
...
def test_literature_create_with_arxiv_eprints(app_clean):
    arxiv_value = faker.arxiv()
...
def test_literature_create_with_dois(app_clean):
    doi_value = faker.doi()
...
def test_literature_create_with_invalid_data(app_clean):
    data = faker.record("lit", with_control_number=True)
...
def test_literature_create_with_invalid_data_and_mutliple_pids(app_clean):
    doi_value = faker.doi()
    arxiv_value = faker.arxiv()
    data = {"arxiv_eprints": [{"value": arxiv_value}], "dois": [{"value": doi_value}]}
    data = faker.record("lit", with_control_number=True, data=data)
...
def test_literature_update(app_clean):
    data = faker.record("lit", with_control_number=True)
    record = LiteratureRecord.create(data)
...
def test_literature_create_or_update_with_new_record(app_clean):
    data = faker.record("lit")
...
def test_literature_create_or_update_with_existing_record(app_clean):
    data = faker.record("lit", with_control_number=True)
    record = LiteratureRecord.create(data)
...
def test_dump_for_es(app_clean):
    additional_fields = {
...
def test_dump_for_es_adds_latex_and_bibtex_displays(app_clean):
    additional_fields = {
        "texkeys": ["a123bx"],
...
def test_dump_for_es_catches_bibtex_exception(mock_bibtex, app_clean):
...
def test_import_article_bad_arxiv_id(app_clean):
    with pytest.raises(UnknownImportIdentifierError):
        import_article("bad_arXiv:1207.7214")


def test_import_article_bad_doi(app_clean):
    with pytest.raises(UnknownImportIdentifierError):
        import_article("doi:Th1s1s/n0taD01")


def test_import_article_arxiv_id_already_in_inspire(app_clean):
    arxiv_value = faker.arxiv()
    data = {"arxiv_eprints": [{"value": arxiv_value}]}
    data = faker.record("lit", with_control_number=True, data=data)
    LiteratureRecord.create(data)
...
def test_import_article_doi_already_in_inspire(app_clean):
    doi_value = faker.doi()
    data = {"dois": [{"value": doi_value}]}
    data = faker.record("lit", with_control_number=True, data=data)
    LiteratureRecord.create(data)
...
def test_create_record_update_citation_table(app_clean):
    data = faker.record("lit")
    record = LiteratureRecord.create(data)
...
def test_update_record_update_citation_table(app_clean):
    data = faker.record("lit")
    record = LiteratureRecord.create(data)
...
def test_complex_records_interactions_in_citation_table(app_clean):
    records_list = []
    for i in range(6):
        data = faker.record(
...
def test_literature_can_cite_data_record(app_clean):
...
def test_literature_cannot_cite_other_than_data_and_literature_record(app_clean):
...
def test_literature_can_cite_only_existing_records(app_clean):
    data = faker.record("dat")
    record = InspireRecord.create(data)
...
def test_literature_is_not_cited_by_deleted_records(app_clean):
    data = faker.record("lit")
    record = InspireRecord.create(data)
...
def test_literature_citation_count_property(app_clean):
    data = faker.record("lit")
    record = InspireRecord.create(data)
...
@mock.patch("inspirehep.records.api.literature.push_to_orcid")
def test_record_create_not_skips_orcid_on_default(orcid_mock, app_clean):
    data1 = faker.record("lit")
    record1 = InspireRecord.create(data1)
...
def test_record_create_skips_citation_recalculate_when_passed_parameter_to_skip(
    citation_recalculate_mock, app_clean
):
    data1 = faker.record("lit")
...
@mock.patch("inspirehep.records.api.literature.push_to_orcid")
def test_record_update_not_skips_orcid_on_default(orcid_mock, app_clean):
    data1 = faker.record("lit")
    data2 = faker.record("lit")
    record1 = InspireRecord.create(data1)
    data2["control_number"] = record1["control_number"]
...
def test_get_modified_references(app_clean):
...
def test_update_authors_signature_blocks_handles_ascii_names(mock_uuid4, app_clean):
...
@mock.patch("inspirehep.records.api.literature.uuid.uuid4")
def test_update_authors_signature_blocks_handles_unicode_names(mock_uuid4, app_clean):
    mock_uuid4.return_value = UUID("727238f3-8ed6-40b6-97d2-dc3cd1429131")
...
@mock.patch("inspirehep.records.api.literature.uuid.uuid4")
def test_update_authors_signature_blocks_handles_jimmy(mock_uuid4, app_clean):
    mock_uuid4.return_value = UUID("727238f3-8ed6-40b6-97d2-dc3cd1429131")
...
@mock.patch("inspirehep.records.api.literature.uuid.uuid4")
def test_update_authors_uuids_does_not_update_existing_uuids(mock_uuid4, app_clean):
    mock_uuid4.return_value = UUID("727238f3-8ed6-40b6-97d2-dc3cd1429131")
    author_data = {
        "authors": [
            {
...
def test_create_record_sends_phonetic_blocks_to_redis(app_clean):
...
def test_update_record_sends_phonetic_blocks_to_redis(app_clean):
    redis = get_test_redis()
    data = faker.record("lit")
    record = LiteratureRecord.create(data)
...
def test_phonetic_blocks_keep_order_in_redis_based_on_timestamp(app_clean):
    redis = get_test_redis()
...
def test_record_cannot_cite_itself(app_clean):
...
@pytest.mark.vcr()
def test_add_record_with_documents_and_figures(app_with_s3):
...
@pytest.mark.vcr()
def test_adding_record_with_documents_skips_hidden(app_with_s3):
    expected_document_key = "f276b50c9e6401b5e212785a496efa4e"
...
@pytest.mark.vcr()
def test_adding_record_with_duplicated_documents_and_figures(app_with_s3):
    expected_figure_key = "a29b7e90ba08cd1565146fe81ebbecd5"
    expected_document_key = "f276b50c9e6401b5e212785a496efa4e"
    create_s3_bucket(expected_figure_key)
    create_s3_bucket(expected_document_key)
...
@pytest.mark.vcr()
def test_adding_record_with_document_without_filename(app_with_s3):
    expected_document_key = "f276b50c9e6401b5e212785a496efa4e"
    create_s3_bucket(expected_document_key)
    data = {
        "documents": [
...
@pytest.mark.vcr()
def test_adding_record_with_documents_with_existing_file_updates_metadata(app_with_s3):
    expected_document_key = "f276b50c9e6401b5e212785a496efa4e"
    create_s3_bucket(expected_document_key)
    data = {
        "documents": [
...
@pytest.mark.vcr()
def test_adding_record_with_documents_with_full_url_without_original_url(app_with_s3):
    expected_document_key = "f276b50c9e6401b5e212785a496efa4e"
    create_s3_bucket(expected_document_key)
    data = {
        "documents": [
...
@pytest.mark.vcr()
def test_adding_deleted_record_with_documents_does_not_add_files(app_with_s3):
    expected_document_key = "f276b50c9e6401b5e212785a496efa4e"
    create_s3_bucket(expected_document_key)
    data = {
        "deleted": True,
...
@pytest.mark.vcr()
def test_update_record_with_documents_and_figures(app_with_s3):
    expected_figure_key = "a29b7e90ba08cd1565146fe81ebbecd5"
    expected_document_key = "f276b50c9e6401b5e212785a496efa4e"
    create_s3_bucket(expected_figure_key)
    create_s3_bucket(expected_document_key)
...
@pytest.mark.vcr()
def test_update_record_remove_documents_and_figures(app_with_s3,):
    expected_figure_key = "a29b7e90ba08cd1565146fe81ebbecd5"
    expected_document_key = "f276b50c9e6401b5e212785a496efa4e"
    create_s3_bucket(expected_figure_key)
    create_s3_bucket(expected_document_key)
...
@pytest.mark.vcr()
def test_update_record_add_more_documents(app_with_s3):
...
def test_literature_updates_refs_to_known_conferences(app_clean):
...
def test_literature_updates_refs_to_known_and_unknown_conference(app_clean):
...
def test_do_not_add_files_which_are_already_on_s3(app_with_s3):
    data = {
        "documents": [
            {
...
def test_files_metadata_is_replaced_when_replacing_metadata_is_enabled(app_with_s3):
...
def test_adding_files_with_s3_url_but_wrong_key(app_with_s3):
    expected_figure_key = "cb071d80d1a54f21c8867a038f6a6c66"
    expected_document_key = "fdc3bdefb79cec8eb8211d2499e04704"
    create_s3_bucket(expected_figure_key)
    create_s3_bucket(expected_document_key)
...
def test_creating_record_updates_entries_in_authors_records_table(app_clean):
...
def test_updating_record_updates_entries_in_authors_records_table(app_clean):
...
def test_deleted_record_do_not_create_entries_in_authors_records_table(app_clean):
    data = {
        "authors": [
            {
                "full_name": "Kathryn Janeway",
...
def test_deleting_record_removes_entries_in_authors_records_table(app_clean):
    data = {
        "authors": [
            {
                "full_name": "Kathryn Janeway",
...
def test_hard_deleting_record_removes_entries_in_authors_records_table(app_clean):
    data = {
        "authors": [
            {
                "full_name": "Kathryn Janeway",
