...
def test_jobs_json(app_clean, datadir):
...
def test_jobs_json_cataloger_can_edit(app_clean, datadir):
    headers = {"Accept": "application/json"}
...
def test_jobs_json_author_can_edit_but_random_user_cant(app_clean, datadir):
    headers = {"Accept": "application/json"}
...
def test_jobs_search_json(app_clean, datadir):
    headers = {"Accept": "application/json"}
...
def test_jobs_search_json_can_edit(app_clean):
    headers = {"Accept": "application/json"}
