...
def user_with_permission(app_clean):
    _user_data = {
...
@pytest.fixture(scope="function")
def two_users_with_permission(app_clean):
    _user1_data = {
        "orcid": "0000-0001-8829-5461",
        "token": "3d25a708-dae9-48eb-b676-aaaaaaaaaaaa",
        "email": "dummy1@email.com",
...
@pytest.fixture(scope="function")
def user_without_permission(app_clean):
    _user_data = {
        "orcid": "0000-0001-8829-5461",
        "token": "3d25a708-dae9-48eb-b676-aaaaaaaaaaaa",
        "email": "dummy1@email.com",
...
@pytest.fixture(scope="function")
def user_without_token(app_clean):
    _user_data = {
        "orcid": "0000-0001-8829-5461",
        "email": "dummy1@email.com",
        "name": "Franz Kärtner",
...
def test_orcid_push_not_triggered_on_create_record_without_allow_push(
    mock_orcid_push_task, app_clean, raw_record, user_without_permission
):
...
def test_orcid_push_not_triggered_on_create_record_without_token(
    mock_orcid_push_task, app_clean, raw_record, user_without_token
):
    migrate_and_insert_record(raw_record)
...
def test_orcid_push_not_triggered_on_create_record_no_feat_flag(
    mocked_Task, app_clean, raw_record, user_with_permission
):
    migrate_and_insert_record(raw_record)
