...
from helpers.utils import app_cli_runner, get_index_alias
...
def teardown_sample_user(app_clean):
    yield
...
@fixture(scope="function")
def teardown_sample_user_2(app_clean):
    yield
...
@fixture(scope="function")
def teardown_sample_user_edited(app_clean):
    yield
...
@fixture(scope="function")
def app_without_config(app_clean):
...
def test_legacy_orcid_arrays(app_clean, redis_setup):
