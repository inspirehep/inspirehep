...
def test_literature_update_force_undelete_flag(inspire_app):
    data = faker.record("lit", with_control_number=True)
    data_1 = faker.record("lit", with_control_number=True)

    record = LiteratureRecord.create(data)
    record_1 = LiteratureRecord.create(data_1)
...
def test_seminar_update_force_undelete_flag(inspire_app):
    ...
    data_1 = faker.record("sem", with_control_number=True)
...
def test_author_update_force_undelete_flag(inspire_app):
    ...
    data_1 = faker.record("aut", with_control_number=True)
...
def test_institution_update_force_undelete_flag(inspire_app):
    ...
    data_1 = faker.record("ins", with_control_number=True)
