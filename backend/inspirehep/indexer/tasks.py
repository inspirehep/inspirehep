...
def batch_index(
    self, records_uuids, request_timeout=None, skip_reference_reindexing=False
):
    ...
    Args:
        ...
        skip_reference_reindexing (bool): if set to True will skip the reference
...
def index_record(
    self, uuid, record_version=None, force_delete=None, skip_reference_reindexing=False
):
    """Record indexing.
