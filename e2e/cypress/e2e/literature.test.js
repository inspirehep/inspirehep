describe('Literature Search', () => {
  ...
  it('matches snapshot for cataloger', () => {
    cy.login('cataloger');
    cy.registerRoute();
    cy.visit('/literature?ui-citation-summary=true');
    cy.waitForRoute();
...
describe('Literature Submission', () => {
  ...
  it('matches snapshot for article form', () => {
    cy.visit('/submissions/literature');
    cy.selectLiteratureDocType('article');
    cy.matchSnapshot();
  });

  it('matches snapshot for thesis form', () => {
    cy.visit('/submissions/literature');
    cy.selectLiteratureDocType('thesis');
    cy.matchSnapshot();
  });

  it('matches snapshot for book form', () => {
    cy.visit('/submissions/literature');
    cy.selectLiteratureDocType('book');
    cy.matchSnapshot();
  });

  it('matches snapshot for book chapter form', () => {
    cy.visit('/submissions/literature');
