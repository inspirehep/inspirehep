...
describe('Self curation', () => {
  ...
  it('curates reference successfully', () => {
    ...
    cy.get('[data-test-id="reference-drawer-radio-1787272"]').as('radioButton');
  ...
  it('curates reference successfully when page is changed', () => {
    ...
    cy.get('[data-test-id="reference-drawer-radio-1688995"]').as('radioButton');
    ...
    cy.get('@referenceTitle').should('have.text', 'Review of Particle Physics');
  });
  ...
  it('curates reference successfully when page size is changed', () => {
    ...
    cy.get('[data-test-id="reference-drawer-radio-1597429"]').as('radioButton');
