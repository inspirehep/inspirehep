...
def hep_create_dag():
    ...
    def check_matches(**context):
        ...
        if is_fuzzy_match:
            return "set_workflow_status_to_fuzzy_matching"
    ...
    def set_workflow_status_to_fuzzy_matching(**context):
        print("set to wait for curator fuzzy_matching")
        workflow_management_hook.set_workflow_status(
            status_name="fuzzy_matching", workflow_id=context["params"]["workflow_id"]
        )
    ...
    (direct_create_task >> set_workflow_status_to_completed())
